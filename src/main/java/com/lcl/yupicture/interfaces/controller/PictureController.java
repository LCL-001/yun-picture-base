...
import com.lcl.yupicture.infrastructure.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.lcl.yupicture.infrastructure.api.imagesearch.ImageSearchApiFacade;
import com.lcl.yupicture.infrastructure.api.imagesearch.model.ImageSearchResult;
...
import com.lcl.yupicture.interfaces.vo.picture.PictureTagCategory;
import com.lcl.yupicture.domain.user.entity.User;
import com.lcl.yupicture.interfaces.vo.picture.PictureVO;
import com.lcl.yupicture.interfaces.vo.space.SpaceLevel;
...
import com.lcl.yupicture.infrastructure.shared.auth.annotation.SaSpaceCheckPermission;
import com.lcl.yupicture.infrastructure.shared.auth.model.SpaceUserPermissionConstant;
...
public class PictureController {
    ...
    public BaseResponse<Boolean> updatePicture(@RequestBody PictureUpdateRequest pictureUpdateRequest,
                                               HttpServletRequest request) {
        pictureApplicationService.updatePicture(pictureUpdateRequest, request);
        return ResultUtils.success(true);
    }
...
//            pictureService.checkPictureAuth(loginUser, picture);
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPage(@RequestBody PictureQueryRequest pictureQueryRequest,
                                                             HttpServletRequest request) {
        Page<Picture> picturePage = pictureApplicationService.listPictureVOByPage(pictureQueryRequest, request);
        // 获取封装类
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageByCache(@RequestBody PictureQueryRequest pictureQueryRequest,
                                                                    HttpServletRequest request) {
        Page<PictureVO> pictureVOPage = pictureApplicationService.listPictureVOByPageByCache(pictureQueryRequest, request);
        // 返回结果
    ...
    public BaseResponse<Boolean> editPicture(@RequestBody PictureEditRequest pictureEditRequest, HttpServletRequest request) {
        pictureApplicationService.editPicture(pictureEditRequest, request);
        return ResultUtils.success(true);
    }
    ...
    public BaseResponse<CreateOutPaintingTaskResponse> createOutPaintingTask(@RequestBody CreatePictureOutPaintingTaskRequest createPictureOutPaintingTaskRequest, HttpServletRequest request) {
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        CreateOutPaintingTaskResponse response = pictureApplicationService.createOutPaintingTask(createPictureOutPaintingTaskRequest, loginUser);
