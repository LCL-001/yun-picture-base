package com.lcl.yupicture.domain.picture.service.impl;
...
import com.lcl.yupicture.infrastructure.manager.upload.file.UploadPictureResult;
...
import com.lcl.yupicture.infrastructure.manager.upload.FilePictureUpload;
import com.lcl.yupicture.infrastructure.manager.upload.PictureUploadTemplate;
import com.lcl.yupicture.infrastructure.manager.upload.URLFilePictureUpload;
...
import com.lcl.yupicture.domain.picture.valueobject.PictureReviewStatusEnum;
...
//            String fileURL = imgElement.attr("src");
    ...
    public void doPictureReview(PictureReviewRequest pictureReviewRequest, User loginUser) {
        ...
        boolean success = pictureRepository.updateById(updatePicture);
    ...
    public Page<PictureVO> listPictureVOByPageByCache(PictureQueryRequest pictureQueryRequest, HttpServletRequest request) {
        ...
        if (Boolean.TRUE.equals(lock)) {
            ...
            try {
                ...
                // 查询数据库
                Page<Picture> picturePage = pictureRepository.page(new Page<>(current, size), getQueryWrapper(pictureQueryRequest));
...
//            }
        ...
        // 查询数据库
        return pictureRepository.page(new Page<>(current, size), this.getQueryWrapper(pictureQueryRequest));
    }
    ...
    public void editPictureByBatch(PictureEditByBatchRequest pictureEditByBatchRequest, User loginUser) {
        ...
        // 6. 操作数据库，批量更新
        boolean update = pictureRepository.updateBatchById(pictureList);
